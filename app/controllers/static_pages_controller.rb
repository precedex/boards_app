class StaticPagesController < ApplicationController
  ...
  def tools
    ...
    @drug_dosing = [
      ...
      ["Peds Anesthesia Drugs, by category",       "http://www.morpheusanesthesia.com/Pediatric_Anesthesia_Drug_Update_ANSE07_PedAnesthERWM.pdf"],
      ["Peds Anesthesia Pocket Ref. (UCSF)",        "http://pedianesthesia.ucsf.edu/pdf_pedirefcard.pdf"],
