  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved site as @site" do
        ...
        post :create, {:site => { "category" => "invalid value" }}, valid_session
        assigns(:site).should be_a_new(Site)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested site" do
        ...
        Site.any_instance.should_receive(:update).with({ "category" => "MyString" })
        put :update, {:id => site.to_param, :site => { "category" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the site as @site" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Site.any_instance.stub(:save).and_return(false)
        put :update, {:id => site.to_param, :site => { "category" => "invalid value" }}, valid_session
        assigns(:site).should eq(site)
      end
