...
describe QuestionsController do
  ...
  let(:valid_attributes) { { "stem" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved question as @question" do
        ...
        post :create, {:question => { "stem" => "invalid value" }}, valid_session
        assigns(:question).should be_a_new(Question)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested question" do
        ...
        Question.any_instance.should_receive(:update).with({ "stem" => "MyString" })
        put :update, {:id => question.to_param, :question => { "stem" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the question as @question" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Question.any_instance.stub(:save).and_return(false)
        put :update, {:id => question.to_param, :question => { "stem" => "invalid value" }}, valid_session
        assigns(:question).should eq(question)
      end
